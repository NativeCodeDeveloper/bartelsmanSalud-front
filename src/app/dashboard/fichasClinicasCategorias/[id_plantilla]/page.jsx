   ...
   async function eliminarCategoriaEspecifica(id_categoria) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-violet-50/30 relative overflow-hidden">
            ...
            {/* Decorative blobs */}
            <div className="pointer-events-none absolute -top-32 -right-32 h-96 w-96 rounded-full bg-violet-100/40 blur-3xl" />
            <div className="pointer-events-none absolute top-1/2 -left-48 h-80 w-80 rounded-full bg-purple-100/30 blur-3xl" />
            ...
            <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
                        <div>
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-50 border border-violet-100 mb-3">
                                ...
                                <span className="text-[11px] font-semibold uppercase tracking-[0.12em] text-violet-600">Categor&iacute;as</span>
                            </div>
                        ...
                        <button
                            ...
                            className="group inline-flex items-center gap-2.5 px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-violet-600 to-purple-500 rounded-xl hover:from-violet-700 hover:to-purple-600 active:scale-[0.98] transition-all duration-150 shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 self-start sm:self-auto"
                        >
                ...
                <div className="mb-6">
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-violet-600 bg-violet-50 border border-violet-200 rounded-xl hover:bg-violet-100 active:scale-[0.98] transition-all duration-150"
                    >
                    ...
                    {mostrarInfo && (
                        <div className="mt-3 bg-white/90 backdrop-blur-sm border border-violet-200/80 rounded-2xl shadow-[0_4px_24px_rgba(139,92,246,0.06)] p-5 sm:p-6">
                            <div className="flex gap-3">
                                <div className="flex-shrink-0 flex items-start justify-center pt-0.5">
                                    <div className="flex items-center justify-center h-8 w-8 rounded-lg bg-violet-100">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4.5 w-4.5 text-violet-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                ...
                                <div>
                                    ...
                                    <div className="bg-slate-50 rounded-xl border border-slate-200/80 p-4 mb-3">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-center gap-2.5">
                                                <span className="flex-shrink-0 inline-flex items-center justify-center h-6 w-6 rounded-lg bg-violet-500 text-[11px] font-bold text-white">1</span>
                                            ...
                                            <div className="flex items-center gap-2.5">
                                                <span className="flex-shrink-0 inline-flex items-center justify-center h-6 w-6 rounded-lg bg-violet-500 text-[11px] font-bold text-white">2</span>
                                            ...
                                            <div className="flex items-center gap-2.5">
                                                <span className="flex-shrink-0 inline-flex items-center justify-center h-6 w-6 rounded-lg bg-violet-500 text-[11px] font-bold text-white">3</span>
                ...
                <div className="space-y-3 sm:space-y-4">
                    ...
                    {categorias.length === 0 && (
                        <div className="bg-white/80 backdrop-blur-sm border border-slate-200/80 rounded-2xl shadow-[0_8px_30px_rgba(15,23,42,0.04)] p-10 sm:p-14 text-center">
                            <div className="mx-auto mb-5 flex items-center justify-center h-16 w-16 rounded-2xl bg-violet-50 border border-violet-200">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-violet-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                        ...
                        >
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between px-4 sm:px-6 py-4 sm:py-5 gap-4">
                                ...
                                <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
                                    <div className="flex-shrink-0 flex items-center justify-center h-11 w-11 rounded-xl bg-gradient-to-br from-violet-500 to-purple-400 shadow-sm shadow-violet-500/20">
                                ...
                                <div className="flex items-center gap-2 sm:gap-2.5 flex-shrink-0 pl-14 sm:pl-0">
                                    <button
                                        ...
                                        className="inline-flex items-center justify-center gap-1.5 h-8 sm:h-9 px-3 sm:px-4 text-xs font-semibold text-white bg-gradient-to-r from-violet-600 to-purple-500 rounded-lg hover:from-violet-700 hover:to-purple-600 active:scale-[0.97] transition-all duration-150 shadow-sm shadow-violet-500/20"
                                    >
            ...
            {modalCategoria && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white rounded-2xl shadow-[0_24px_80px_rgba(15,23,42,0.18)] w-full max-w-md overflow-hidden border border-slate-200/50">
                        {/* Header */}
                        <div className="relative px-6 py-5 bg-gradient-to-r from-violet-600 to-purple-500 overflow-hidden">
                        ...
                        <div className="p-6 space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full h-10 px-3.5 text-sm border border-slate-200 rounded-xl bg-slate-50/50 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-400 focus:bg-white transition-all placeholder:text-slate-400"
                                    autoFocus
                                />
                            </div>
                            <div>
                        ...
                        <div className="flex items-center justify-end gap-2.5 px-6 py-4 border-t border-slate-100 bg-slate-50/50">
                            ...
                            <button
                                ...
                                className="px-5 py-2 text-sm font-semibold text-white bg-gradient-to-r from-violet-600 to-purple-500 rounded-xl hover:from-violet-700 hover:to-purple-600 active:scale-[0.97] transition-all duration-150 shadow-sm shadow-violet-500/25"
                            >
